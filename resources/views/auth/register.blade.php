				...
				<div class="card-content m-t-20">
					...
					<form action="{{route('register')}}" method="POST" role="form">
						...
						<div class="field">
							...
							<p class="control">
								<input type="text" class="input {{ $errors->has('name') ? ' is-danger' : '' }}" name="name" id="name" value="{{ old('name') }}">
							</p>
							@if($errors->has('name'))
						...
						<button class="button is-primary is-outlined is-fullwidth m-t-10">Register</button>
					</form>
				</div>
